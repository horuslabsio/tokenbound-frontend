...
const LowResHeroImages = () => {
  return (
    <div
      aria-hidden
      className="absolute grid h-[calc(100%-8rem)] w-full grid-cols-2 gap-4 lg:grid-cols-3 lg:gap-0"
    >
      <div className="relative mt-auto h-[75%] w-[50vw] max-w-[400px]">
        <div className="absolute left-12 top-4 h-[7.8rem] w-[7.8rem]">
          <Image src={IMG_0} alt="" />
        </div>
        <div className="absolute top-1/2 h-[7.8rem] w-[6.8rem] -translate-y-1/2">
          <Image src={IMG_1} className="bg-contain" alt="" />
        </div>
      ...
      <div className="relative mt-auto h-[60%]">
        <div className="absolute left-1/2 h-[4.125rem] w-[18.5rem] -translate-x-1/2">
          <Image src={IMG_7} alt="" />
        </div>
        <div className="absolute left-[2rem] top-1/2 h-[4.125rem] w-[18rem] -translate-y-1/2">
          <Image src={IMG_8} alt="" />
        </div>
        <div className="absolute bottom-16 left-1/2 h-[4.125rem] w-[18rem] -rotate-3">
          <Image src={IMG_9} alt="" />
        </div>
      </div>
    </div>
