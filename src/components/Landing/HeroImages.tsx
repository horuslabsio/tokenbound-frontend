  ...
  return (
    ...
    >
      <div className="relative mt-auto h-[75%] max-w-[400px]">
        ...
        <div className="absolute top-1/2 h-[7.8rem] w-[7.8rem] -translate-x-[10%] -translate-y-1/2">
          <Image src={IMG_1} alt="" />
        </div>
      ...
      <div className="relative mt-auto h-[60%]">
        ...
        <div className="absolute bottom-16 h-[4.125rem] w-[19.6rem] translate-x-[90%] -rotate-3">
          <Image src={IMG_9} alt="" />
        </div>
      </div>
    </div>
